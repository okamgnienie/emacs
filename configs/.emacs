...
")
 ...
 '(tab-width 2)
 '(tide-server-max-response-length 100000000)
 '(tide-sync-request-timeout 100000000)
...
(custom-set-faces
 ...
 '(mode-line ((t (:background "#393939" :foreground "#AAAAAA" :box (:line-width 1 :color "#393939")))))
